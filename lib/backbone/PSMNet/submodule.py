...
class feature_extraction(nn.Module):
    ...
    def forward(self, x):
        ...
        output_feature_full = torch.cat((output_raw, output_skip, output_branch4, output_branch3, output_branch2, output_branch1), 1)
        output_feature = self.lastconv(output_feature_full)

        return output_feature, output_feature_full
